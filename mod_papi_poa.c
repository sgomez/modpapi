 ...
 */
static char    *
papi_request_get_cookie(apr_pool_t * p, const apr_table_t * src, const char *name)
{
	const char     *cookies;
 ...
 */
static char   **
papi_split_assertion(request_rec * r, const char *str, const char token, int n)
{
 ...
 */
static int 
papi_test_filters(request_rec * r, papi_dir_config * d, char *assert)
{
...
const char     *
papi_build_attrList(request_rec * r, papi_dir_config * d, char *assert)
{
...
static char    *
papi_user_data_rewrite(request_rec * r, papi_dir_config * d, char *assert)
{
...
static int 
papi_test_as(request_rec * r, papi_dir_config * d, char *as)
{
...
char           *
papi_test_url(request_rec * r, papi_dir_config * d, int *valid_data)
{
	*valid_data = 0;
...
char           *
papi_test_gpoa_url(request_rec * r, papi_dir_config * d, char **code, int *valid_date)
{
	*code = NULL;
	*valid_date = 0;
...
char           *
papi_pub_keyfile(request_rec * r, papi_dir_config * d, const char *as)
{
...
char           *
papi_priv_keyfile(apr_pool_t * p, papi_dir_config * d, const char *gpoa)
{
...
char           *
papi_gen_lcook(request_rec * r, papi_dir_config * d, int init, const char *code)
{
...
char           *
papi_test_lcook(request_rec * r, papi_dir_config * d, int *init)
{
...
char           *
papi_gen_logout_lcook_cookie(request_rec * r, papi_dir_config * d)
{
...
poa_request_t  *
papi_load_request(request_rec * r, papi_dir_config * d, char *request_id)
{
...
char           *
papi_save_request(request_rec * r, papi_dir_config * d)
{
	const apr_dbd_driver_t *driver = NULL;
#ifdef APR_DBD_SQLITE3
	apr_dbd_prepared_t *req_statement = NULL;
...
static apr_dbd_t *
papi_dbd_open(request_rec * r, papi_dir_config * d, const apr_dbd_driver_t * driver)
{
	apr_dbd_t      *handle = NULL;
	apr_status_t    status;
