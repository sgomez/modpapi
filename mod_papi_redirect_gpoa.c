...
static int 
papi_builtin_wayf(request_rec * r, papi_dir_config * d)
{
...
int 
papi_redirect_gpoa(request_rec * r, papi_dir_config * d)
{
	char           *poa_uri;
