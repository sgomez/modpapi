...
const char     *
papi_set_parameters(request_rec * r, papi_dir_config * d)
{
...
const char     *
papi_set_file_slot(cmd_parms * parms,
		   void *config,
		   const char *arg)
{
	apr_finfo_t     finfo;
...
const char     *
papi_set_path_slot(cmd_parms * parms,
		   void *config,
		   const char *arg)
{
...
const char     *
papi_set_papi_as_slot(cmd_parms * parms,
		      void *config,
		      const char *args)
{
...
const char     *
papi_set_gpoa_url_slot(cmd_parms * parms,
		       void *config,
		       const char *id,
		       const char *url)
{
...
const char     *
papi_set_signoff_location_slot(cmd_parms * parms,
			       void *config,
			       const char *re,
			       const char *url)
{
...
const char     *
papi_set_pass_url_pattern_slot(cmd_parms * parms,
			       void *config,
			       const char *re)
{
	papi_dir_config *d = (papi_dir_config *) config;
...
const char     *
papi_set_papi_filter_slot(cmd_parms * parms,
			  void *config,
			  const char *re,
			  const char *accept)
{
...
const char     *
papi_set_cookie_reject_slot(cmd_parms * parms,
			    void *config,
			    const char *re)
{
	papi_dir_config *d = (papi_dir_config *) config;
...
const char     *
papi_set_user_data_rewrite_slot(cmd_parms * parms,
				void *config,
				const char *re,
				const char *rs)
{
...
const char     *
papi_set_attribute_slot(cmd_parms * parms,
			void *config,
...
const char     *
papi_set_value_slot(cmd_parms * parms,
		    void *config,
		    const char *value)
{
	papi_dir_config *dir = (papi_dir_config *) config;
...
const char     *
papi_set_gpoa_rewrite_slot(cmd_parms * parms,
			   void *config,
			   const char *poa_re,
			   const char *re,
			   const char *rs)
