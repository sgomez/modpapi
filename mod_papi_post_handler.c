...
static size_t 
papi_post_read_data(void *ptr, size_t size, size_t nmemb, void *data)
{
...
int 
papi_post_handler(request_rec * r, papi_dir_config * d, const char *post)
{
...
int 
papi_read_body(request_rec * r, char **buffer)
{
	char            buf[MAX_SIZE + 1];
